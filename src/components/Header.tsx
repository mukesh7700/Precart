...
const HeaderUsage = (props: HeaderProps) => {
  ...
  return (
    <>
      <Header className="flex justify-between px-4" {...props}>
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex justify-between items-center gap-6">
            ...
            <Popover
              trigger={
                <IconButton className="underline-offset-8 hover:underline" variant="text" label="Popover Trigger">
                  pages
                </IconButton>
              }
            ...
            >
              <Text as="p" className="w-screen h-36">This is a Popover content</Text>
            </Popover>
            <Popover
              trigger={
                <IconButton variant="text" label="Popover Trigger">
                  Men
                </IconButton>
              }
              className="p-2"
      ...
      <IconButton  label="" className="md:hidden" onClick={handleOpen}>
      <CiMenuKebab />
      </IconButton>
      <DrawerUsage  isOpen={isOpen} onClose={handleClose} setIsOpen={setIsOpen} />
