...
import { Account, Email, Gift, Location, Return, ShopingBeg, Wallet } from '@/components/svgs2';
        ...
        <section className='container mx-auto'>
            <div className='py-10 '>
                ...
                <div className='flex justify-between items-center'>
                    <Card className="px-0 pb-4 bg-transparent">
                        <CardHeader
                    ...
                    <Link href="#" className='text-lg font-semibold  underline underline-offset-8 hover:text-violet-400'>Logout</Link>
                </div>
